...
function changeImage(i, lableList) {//i代表测试的视频序号
    var img_path = new Array()

    // for(var j=0;j<2+testFunc.length;j++){
    //     if(j==0){
    //         img_path[j] = path + 'rgb' + '/' + names[i] + '.png'
    //         // img_path[j]='C:/Users/JuewenPeng/Documents/SmartLab/CVPR2022/Figures/Fig1/iphone.jpg'
    //     }
    //     else if(j==1){
    //         img_path[j] = path + 'reference' + '/' + names[i] + '.png'
    //         // img_path[j]='C:/Users/JuewenPeng/Documents/SmartLab/CVPR2022/Figures/Fig1/iphone.jpg'
    //     }
    //     else {
    //         img_path[j] = path + testFunc[j-2] + '/' + names[i] + '.mp4'
    //         // img_path[j]='C:/Users/JuewenPeng/Documents/SmartLab/CVPR2022/Figures/Fig1/iphone_bokeh.jpg'
    //     }
    // }

    //生成每个方法的视频路径
    for(var j=0;j<testFunc.length;j++){
        img_path[j] = path + testFunc[j] + '/' + names[i] + '.mov'
    }
    ...
    for (var j=0;j<imgs.length;j++)
    {
        ...
        var num = lableList[j]
        imgs[j].setAttribute('src',img_path[num])
    ...
    //     }
    //     else {
    //         var num = lableList[j-2]
    //         imgs[j].setAttribute('src',img_path[num+2])
    //         // labels[j].innerText = testFunc[num]
    //         // labels[j].innerText = j
    //     }
    // }
...
function randomChangeImage(i){
    ...
    var label1 = getRandom(numfunc-1)//随机选择一个其他方法
    // console.log(label1)
    var label2 = numfunc-1//ours
    labelListTop2 = [label1, label2]
    labelListTop2.sort(randomSort)//随机排序
